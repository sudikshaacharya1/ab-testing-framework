...
from abkit.stats.cuped import cuped_adjust
from abkit.stats.sequential import msprt_test
from abkit.stats.power import minimum_detectable_effect
from abkit.stats.guardrails import check_guardrails
from abkit.novelty.correction import detect_novelty_effect
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if args.report:
        from abkit.reporting import generate_html_report
